                ...
                <div class="carousel-item active" data-bs-interval="10000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-white fs-4">
                            {{ __('ui.vendi i tuoi Articoli su Affari.it') }}</p>
                    </div>
                </div>
                ...
                <div class="row my-3">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/3">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#5c8001;" xmlns="http://www.w3.org/2000/svg" width="100"
                                    height="100" fill="currentColor" class="bi bi-tv-fill" viewBox="0 0 16 16">
                                    <path
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('register') }}">
                                        <button class="gradient-custom btn btn-register-aler px-5 text-light"
                                            type="submit">
                                            {{ __('ui.registrati') }}
                                        </button>
                                    </a>

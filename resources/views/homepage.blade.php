            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active" data-bs-interval="10000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="text-white fs-1">Pubblica un articolo che non usi</h5>
                        <p class="text-white fs-4">Some representative placeholder content for the first slide.</p>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="/img-carouselTwo.jpeg" class="d-block w-100 imgCarhome" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="text-white fs-1">Vendi o acquista</h5>
                        <p class="text-white fs-4">Some representative placeholder content for the first slide.</p>
                    </div>
                </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 d-flex justify-content-center px-1">
                        ...
                        <a class="linkShow" href="{{route('announcement.show',['announcement' => $announcement])}}">
                            <div class="cardBox my-4">
                                <img class="img-card-official" src="{{ !$announcement->images->isEmpty() ? $announcement->images->first()->getUrl(215, 230) : asset('img/default-image.jpg') }}">
                ...
                <div class="row my-3">
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/1">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#c44536;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-car-front-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/2">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#0466c8;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-pc-display" viewBox="0 0 16 16">
                ...
                <div class="row my-3">
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/4">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#fbb02d;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-book-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/5">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#99582a;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-joystick" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/6">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#62b6cb;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-bicycle" viewBox="0 0 16 16">
                ...
                <div class="row my-3">
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/7">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#7678ed;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/8">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#6d6875;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-phone-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-center">
                        <a href="http://127.0.0.1:8000/category/9">
                            <div class="d-flex flex-column justify-content-center containerCatRound">
                                <svg style="color:#73ba9b;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-lamp-fill" viewBox="0 0 16 16">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-secondary py-5" role="alert">
                            <div>
                                <h4 class="text-center titoloCategoriaScript text-light m-0 pt-3" style="color:#444444!important">
                                    Lavora con noi!
                                </h4>
                                <p class="text-center text-dark mt-5 fs-5">
                                    Diventa revisore basta registrarti <br>
                                    scopri come
                                </p>
